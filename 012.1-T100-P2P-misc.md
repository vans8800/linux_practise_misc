...
```bash
#busybox devmem 0x0038000054 8 0x10
#busybox devmem 0x0039101054 8 0x10
...
#           +-08.0  Loongson Technology LLC Device 7a18
#           +-09.0-[03]--
#           +-0a.0-[04-05]----00.0-[05]----00.0  ASPEED Technology, Inc. ASPEED Graphics Family
#           +-0b.0-[06]----00.0  Device 1f0a:6801
#           +-0c.0-[07]----00.0  Device 1f0a:6801
#           +-0d.0-[08]--
#           +-0f.0-[09]--
#           +-10.0-[0a]--
#           +-16.0  Loongson Technology LLC Device 7a1b
#           +-19.0  Loongson Technology LLC Device 7a34
#           +-1c.0-[0b-0d]--+-00.0-[0c]----00.0  Device 2006:0100
#           |               \-01.0-[0d]--
#           +-1d.0  Loongson Technology LLC Device 3c0f
#           \-1e.0-[0e-12]--+-00.0-[0f]--
#                           +-01.0-[10]----00.0  Device 2006:0100
#                           +-02.0-[11]--
#                           +-03.0-[12]----00.0  YEESTOR Microelectronics Co., Ltd Device ef25
#                           \-04.0  Loongson Technology LLC Device 3c0f
#[root@localhost P2P]# lspci -n |grep 2006
#0c:00.0 1200: 2006:0100 (rev 01)
#10:00.0 1200: 2006:0100 (rev 01)
#
#
#
# 这里需要找到AI卡紧挨着的上一级的信息 
# 0c:00.0 的上一级为 0b:00.0
# 10:00.0 的上一级为 0e:00.0  

#lspci -vv -s 0b:00.0 | grep "Region 0" && lspci -vv -s  0e:01.0 | grep -i "Region 0"
#	Region 0: Memory at e003c000000 (64-bit, non-prefetchable) [size=4K]
#	Region 0: Memory at e003d101000 (64-bit, non-prefetchable) [size=4K]

busybox devmem 0xe003c000054 8 0x10
busybox devmem 0xe003d101054 8 0x10
```
